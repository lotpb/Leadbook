...
?>  
<form id="form1" name="form1" method="get" action="CustTableipad.php">
<input name="Search" type="search" id="Search" autofocus value="<?php echo $_REQUEST['Search']; ?>" size="18" /> 
...
<form id="form4" name="form4" method="get" action="CustTableipad.php"> 
