...
if ((navigator.userAgent.indexOf('iPhone') != -1) || (navigator.userAgent.indexOf('iPod') != -1) || (navigator.userAgent.indexOf('iPad') != -1)) {
		document.location = "LeadTableipad.php";
	} // ]]>
...
?>
<form id="form1" name="form1" method="get" action="LeadTable.php">
<input name="Search" type="search" id="Search" autofocus value="Search <?php echo $_GET['Search']; ?>" size="18" />
...
$strParam="caption=Leads by Month; subCaption=; decimalPrecision=0; showPercentageValues=0; showNames=1; numberPrefix=; showValues=1; showPercentageInLabel=0; pieYScale=45; pieBorderAlpha=40; pieFillAlpha=100; pieSliceDepth=15; pieRadius=100; chartTopMargin=0; chartBottomMargin=0; chartRightMargin=0; chartLeftMargin=0";
...
$FC->setSwfPath("FusionCharts/");
$FC->setChartMessage("ChartNoDataText=Chart Data not provided; PBarLoadingText=Please Wait.The chart is loading...");
$strParam="caption=Leads by Year; subCaption=; xAxisName=; showBorder='0'; showNames=1; formatNumberScale=1; numberSuffix=; decimalPrecision=0; chartBottomMargin=0; chartRightMargin=0; chartLeftMargin=0; chartTopMargin=0";
$FC->setChartParams($strParam); 
...
$FC->setSwfPath("FusionCharts/");
$FC->setChartMessage("ChartNoDataText=Chart Data not provided; PBarLoadingText=Please Wait.The chart is loading...");
$strParam="caption=Avg Leads by Year; subCaption=; xAxisName=; showBorder='0'; showNames=1; formatNumberScale=1; numberSuffix=; decimalPrecision=0; chartBottomMargin=0; chartRightMargin=0; chartLeftMargin=0; chartTopMargin=0";
$FC->setChartParams($strParam); 
$result = mysql_query($query_fmAvgLeadGraph) or die(mysql_error());
if ($result) 
...
<form id="form5" name="form5" method="get" action="LeadTable.php">
